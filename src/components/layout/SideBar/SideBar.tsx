  ...
  switch (role) {
    ...
    case 'HABITANT':
      return [
        ...
        { label: "Calendrier",    path: "/habitant/calendrier", icon: "calendar" },
        { label: "Historique",    path: "/habitant/historique", icon: "clock"    },
      ];
    case 'ADMIN':
      return [
...
const NavIcon = ({ name, active }: { name: string; active: boolean }) => {
  ...
  const icons: Record<string, JSX.Element> = {
    ...
    // N'existait pas dans le projet (vérifié) — ajoutée pour Calendrier
    // (espace habitant), même style que les autres icônes du set.
    calendar: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>,
